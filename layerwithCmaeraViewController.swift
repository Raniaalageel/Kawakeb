//
//  layerwithCmaeraViewController.swift
//  Kawakeb
//
//  Created by Sara Alsaleh on 24/06/1444 AH.
//
...
import AVFoundation
import Vision
class layerwithCmaeraViewController: UIViewController,AVCaptureVideoDataOutputSampleBufferDelegate {
