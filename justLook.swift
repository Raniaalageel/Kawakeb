...
//  Kawakeb
//
//  Created by Sara Alsaleh on 25/07/1444 AH.
//

import UIKit

class justLook: UIViewController {
...
//           checkArray()
//           }
//           doMove(label: arrayWithLabel[current])
//           return
//
//
//
...
//                                  if (player.position.x + 180) < scene!.size.width {
//                                      actions.append(SKAction.move(by: .init(dx: 180, dy: 0), duration: 2))
//                                  } else {
//                                      current = arrayWithLabel.count - 1
//                                      OutOfrange()
//                                      return
//                                  }
//
...
//                        if (player.position.y + 190) < scene!.size.width {
//                                      actions.append(SKAction.move(by: .init(dx: 0, dy: 190), duration: 2))
//                                  } else {
//                                      current = arrayWithLabel.count - 1
//                                      OutOfrange()
...
//
//actions.append(.run({
//            if self.current + 1 < self.arrayWithLabel.count {
//                       self.current += 1
//    doMove(label: self.arrayWithLabel[self.current])
//                   } else if (self.cnodtionArray == true && Global.shared.EmptyStopArray == true) {
//                       self.winCondition()
//                   }
//               }))
//
